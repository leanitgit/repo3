...
@Component({
  selector: 'app-work-tracker-page',
  templateUrl: './work-tracker-page.component.html',
  styleUrls: ['./work-tracker-page.component.scss']
})
export class WorkTrackerPageComponent implements OnInit {
